...
class Projects extends CI_Controller{
    ...
    public function display($project_id) {
        ...
        $data['main_view'] = "projects/display"; //Loading the view
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->project_model->create_project($data)) { //If we are able to create some data...
        ...
        public function edit($project_id) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($this->project_model->edit_project($project_id, $data)) { //If we are able to edit some data...
