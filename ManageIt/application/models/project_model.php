...
class Project_model extends CI_Model {
    ...
    public function get_project_tasks($project_id, $active = true){  //Creating a dynamic table that we will pull data from
        ...
        $this->db->from('tasks'); //From where I want to join
